...
type (
	...
	// MergeDiscoveredAssetsAssetsCommand is the command line data structure for the mergeDiscoveredAssets action of assets
	MergeDiscoveredAssetsAssetsCommand struct {
		Payload     string
		ContentType string
		// Team ID
		TeamID      string
...
annotations already present in the asset.`,
	...
	tmp55 := new(MergeDiscoveredAssetsAssetsCommand)
	sub = &cobra.Command{
...

{
   ...
   "group_name": "discoveryserviceX-discovered-assets"
	...
	tmp60 := new(PutAssetAnnotationsCommand)
	sub = &cobra.Command{
		Use:   `asset-annotations ["/api/v1/teams/TEAM_ID/assets/ASSET_ID/annotations"]`,
		Short: ``,
		Long: `
...

{
   "annotations": {
	...
	tmp61 := new(SendScanReportCommand)
	sub = &cobra.Command{
...
If no dates are specified, the time range will be set for the last 30 days.`,
	...
	tmp62 := new(SendDigestReportCommand)
	sub = &cobra.Command{
...

{
   ...
   "start_date": "2020-08-11"
	...
	command.AddCommand(sub)
	tmp69 := new(ShowPolicySettingsCommand)
	sub = &cobra.Command{
		Use:   `policy-settings ["/api/v1/teams/TEAM_ID/policies/POLICY_ID/settings/SETTINGS_ID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp72 := new(ShowScanReportCommand)
	sub = &cobra.Command{
		Use:   `scan report ["/api/v1/teams/TEAM_ID/scans/SCAN_ID/report"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp73 := new(ShowTeamMembersCommand)
	sub = &cobra.Command{
		Use:   `team-members ["/api/v1/teams/TEAM_ID/members/USER_ID"]`,
		Short: ``,
	...
	tmp75 := new(SubmitAFindingOverwriteFindingsCommand)
	sub = &cobra.Command{
		Use:   `findings ["/api/v1/teams/TEAM_ID/findings/FINDING_ID/overwrites"]`,
		Short: ``,
		Long: `
...

{
   ...
   "options": "{\"timeout\":60}"
	...
	command.AddCommand(sub)
	tmp80 := new(UpdatePoliciesCommand)
	sub = &cobra.Command{
		Use:   `policies ["/api/v1/teams/TEAM_ID/policies/POLICY_ID"]`,
		Short: ``,
		Long: `
...

{
   "name": "Sample Policy"
	...
	command.AddCommand(sub)
	tmp81 := new(UpdatePolicySettingsCommand)
	sub = &cobra.Command{
		Use:   `policy-settings ["/api/v1/teams/TEAM_ID/policies/POLICY_ID/settings/SETTINGS_ID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "options": "{\"timeout\":60}"
	...
	command.AddCommand(sub)
	tmp82 := new(UpdateProgramsCommand)
	sub = &cobra.Command{
		Use:   `programs ["/api/v1/teams/TEAM_ID/programs/PROGRAM_ID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "policy_groups": [
	...
	command.AddCommand(sub)
	tmp83 := new(UpdateRecipientsCommand)
	sub = &cobra.Command{
		Use:   `recipients ["/api/v1/teams/TEAM_ID/recipients"]`,
		Short: ``,
		Long: `
...

{
   "emails": [
	...
	command.AddCommand(sub)
	tmp84 := new(UpdateScheduleCommand)
	sub = &cobra.Command{
		Use:   `schedule ["/api/v1/teams/TEAM_ID/programs/PROGRAM_ID/schedule"]`,
		Short: ``,
		Long: `
...

{
   "cron": "0 7 1 * *"
	...
	command.AddCommand(sub)
	tmp85 := new(UpdateTeamMembersCommand)
	sub = &cobra.Command{
		Use:   `team-members ["/api/v1/teams/TEAM_ID/members/USER_ID"]`,
		Short: ``,
		Long: `
...
// Run makes the HTTP request corresponding to the MergeDiscoveredAssetsAssetsCommand command.
func (cmd *MergeDiscoveredAssetsAssetsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.MergeDiscoveredAssetsAssets(ctx, path, &payload)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *MergeDiscoveredAssetsAssetsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	cc.Flags().StringVar(&cmd.Payload, "payload", "", "Request body encoded in JSON")
	cc.Flags().StringVar(&cmd.ContentType, "content", "", "Request content type override, e.g. 'application/x-www-form-urlencoded'")
	var teamID string
	cc.Flags().StringVar(&cmd.TeamID, "team_id", teamID, `Team ID`)
...
func (cmd *ListFindingsIssuesFindingsCommand) Run(c *client.Client, args []string) error {
	...
	resp, err := c.ListFindingsIssuesFindings(ctx, path, stringFlagVal("atDate", cmd.AtDate), stringFlagVal("identifiers", cmd.Identifiers), stringFlagVal("labels", cmd.Labels), stringFlagVal("maxDate", cmd.MaxDate), stringFlagVal("minDate", cmd.MinDate), tmp99, tmp100, stringFlagVal("sortBy", cmd.SortBy), stringFlagVal("status", cmd.Status), stringFlagVal("targetID", cmd.TargetID))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *CurrentExposureGlobalStatsCommand) Run(c *client.Client, args []string) error {
	...
	resp, err := c.CurrentExposureGlobalStats(ctx, path, tmp103, tmp104)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *ExposureGlobalStatsCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.MaxScore != "" {
		var err error
		tmp105, err = float64Val(cmd.MaxScore)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *float64 value", "flag", "--maxScore", "err", err)
			return err
		}
	...
	if cmd.MinScore != "" {
		var err error
		tmp106, err = float64Val(cmd.MinScore)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *float64 value", "flag", "--minScore", "err", err)
			return err
		}
	}
	resp, err := c.ExposureGlobalStats(ctx, path, stringFlagVal("atDate", cmd.AtDate), tmp105, tmp106)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *CurrentExposureStatsCommand) Run(c *client.Client, args []string) error {
	...
	resp, err := c.CurrentExposureStats(ctx, path, tmp107, tmp108)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *ExposureStatsCommand) Run(c *client.Client, args []string) error {
	...
	resp, err := c.ExposureStats(ctx, path, stringFlagVal("atDate", cmd.AtDate), tmp109, tmp110)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
