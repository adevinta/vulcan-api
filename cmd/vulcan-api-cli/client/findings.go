...
func (c *Client) FindFindingsFromAIssueFindings(ctx context.Context, path string, atDate *string, identifiers *string, maxDate *string, maxScore *float64, minDate *string, minScore *float64, page *float64, size *float64, sortBy *string, status *string) (*http.Response, error) {
	req, err := c.NewFindFindingsFromAIssueFindingsRequest(ctx, path, atDate, identifiers, maxDate, maxScore, minDate, minScore, page, size, sortBy, status)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewFindFindingsFromAIssueFindingsRequest(ctx context.Context, path string, atDate *string, identifiers *string, maxDate *string, maxScore *float64, minDate *string, minScore *float64, page *float64, size *float64, sortBy *string, status *string) (*http.Request, error) {
	scheme := c.Scheme
	if scheme == "" {
		scheme = "https"
	}
	...
	if maxScore != nil {
		tmp102 := strconv.FormatFloat(*maxScore, 'f', -1, 64)
		values.Set("maxScore", tmp102)
	}
	if minDate != nil {
		values.Set("minDate", *minDate)
	}
	if minScore != nil {
		tmp103 := strconv.FormatFloat(*minScore, 'f', -1, 64)
		values.Set("minScore", tmp103)
	}
	if page != nil {
		tmp104 := strconv.FormatFloat(*page, 'f', -1, 64)
		values.Set("page", tmp104)
	}
	if size != nil {
		tmp105 := strconv.FormatFloat(*size, 'f', -1, 64)
		values.Set("size", tmp105)
	}
	if sortBy != nil {
...
func (c *Client) FindFindingsFromATargetFindings(ctx context.Context, path string, atDate *string, identifiers *string, maxDate *string, maxScore *float64, minDate *string, minScore *float64, page *float64, size *float64, sortBy *string, status *string) (*http.Response, error) {
	req, err := c.NewFindFindingsFromATargetFindingsRequest(ctx, path, atDate, identifiers, maxDate, maxScore, minDate, minScore, page, size, sortBy, status)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewFindFindingsFromATargetFindingsRequest(ctx context.Context, path string, atDate *string, identifiers *string, maxDate *string, maxScore *float64, minDate *string, minScore *float64, page *float64, size *float64, sortBy *string, status *string) (*http.Request, error) {
	scheme := c.Scheme
	if scheme == "" {
		scheme = "https"
	}
	...
	if maxScore != nil {
		tmp106 := strconv.FormatFloat(*maxScore, 'f', -1, 64)
		values.Set("maxScore", tmp106)
	}
	if minDate != nil {
		values.Set("minDate", *minDate)
	}
	if minScore != nil {
		tmp107 := strconv.FormatFloat(*minScore, 'f', -1, 64)
		values.Set("minScore", tmp107)
	}
	if page != nil {
		tmp108 := strconv.FormatFloat(*page, 'f', -1, 64)
		values.Set("page", tmp108)
	}
	if size != nil {
		tmp109 := strconv.FormatFloat(*size, 'f', -1, 64)
		values.Set("size", tmp109)
	}
	if sortBy != nil {
		values.Set("sortBy", *sortBy)
	}
...
func (c *Client) ListFindingsFindings(ctx context.Context, path string, atDate *string, identifier *string, identifiers *string, issueID *string, maxDate *string, maxScore *float64, minDate *string, minScore *float64, page *float64, size *float64, sortBy *string, status *string, targetID *string) (*http.Response, error) {
	req, err := c.NewListFindingsFindingsRequest(ctx, path, atDate, identifier, identifiers, issueID, maxDate, maxScore, minDate, minScore, page, size, sortBy, status, targetID)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewListFindingsFindingsRequest(ctx context.Context, path string, atDate *string, identifier *string, identifiers *string, issueID *string, maxDate *string, maxScore *float64, minDate *string, minScore *float64, page *float64, size *float64, sortBy *string, status *string, targetID *string) (*http.Request, error) {
	scheme := c.Scheme
	if scheme == "" {
		scheme = "https"
	}
...
func (c *Client) ListFindingsIssuesFindings(ctx context.Context, path string, atDate *string, identifiers *string, maxDate *string, minDate *string, page *float64, size *float64, sortBy *string, status *string, targetID *string) (*http.Response, error) {
	req, err := c.NewListFindingsIssuesFindingsRequest(ctx, path, atDate, identifiers, maxDate, minDate, page, size, sortBy, status, targetID)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewListFindingsIssuesFindingsRequest(ctx context.Context, path string, atDate *string, identifiers *string, maxDate *string, minDate *string, page *float64, size *float64, sortBy *string, status *string, targetID *string) (*http.Request, error) {
	scheme := c.Scheme
	if scheme == "" {
		scheme = "https"
	}
	...
	if page != nil {
		tmp114 := strconv.FormatFloat(*page, 'f', -1, 64)
		values.Set("page", tmp114)
	}
	if size != nil {
		tmp115 := strconv.FormatFloat(*size, 'f', -1, 64)
		values.Set("size", tmp115)
	}
	if sortBy != nil {
		values.Set("sortBy", *sortBy)
	}
...
func (c *Client) ListFindingsTargetsFindings(ctx context.Context, path string, atDate *string, identifiers *string, issueID *string, maxDate *string, minDate *string, page *float64, size *float64, sortBy *string, status *string) (*http.Response, error) {
	req, err := c.NewListFindingsTargetsFindingsRequest(ctx, path, atDate, identifiers, issueID, maxDate, minDate, page, size, sortBy, status)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewListFindingsTargetsFindingsRequest(ctx context.Context, path string, atDate *string, identifiers *string, issueID *string, maxDate *string, minDate *string, page *float64, size *float64, sortBy *string, status *string) (*http.Request, error) {
	scheme := c.Scheme
	if scheme == "" {
		scheme = "https"
	}
