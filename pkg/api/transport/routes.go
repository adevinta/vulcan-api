...
func AttachRoutes(e endpoint.Endpoints, logger kitlog.Logger) http.Handler {
	...
	r.Methods("GET").Path("/api/v1/teams/{team_id}/findings/{finding_id}/override").Handler(newServer(e[endpoint.ListFindingOverrides], endpoint.FindingsRequest{}, logger, endpoint.ListFindingOverrides))
	r.Methods("POST").Path("/api/v1/teams/{team_id}/findings/{finding_id}/override").Handler(newServer(e[endpoint.CreateFindingOverride], endpoint.FindingOverrideRequest{}, logger, endpoint.CreateFindingOverride))
