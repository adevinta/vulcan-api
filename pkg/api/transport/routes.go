...
func AttachRoutes(e endpoint.Endpoints, logger kitlog.Logger) http.Handler {
	...
	r.Methods("GET").Path("/api/v1/teams/{team_id}/findings/{finding_id}/overwrite").Handler(newServer(e[endpoint.ListFindingOverwrites], endpoint.FindingsRequest{}, logger, endpoint.ListFindingOverwrites))
	r.Methods("POST").Path("/api/v1/teams/{team_id}/findings/{finding_id}/overwrite").Handler(newServer(e[endpoint.CreateFindingOverwrite], endpoint.FindingOverwriteRequest{}, logger, endpoint.CreateFindingOverwrite))
